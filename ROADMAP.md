...
18. **Data services:** Redshift, OpenSearch/ES, Neptune, DocumentDB — each separate scanner; prioritize by user demand. *(Glue catalog database+table + Athena workgroups+data-catalogs landed; Glue crawlers/jobs/triggers/classifiers/connections deferred within Glue itself; Athena named-queries/prepared-statements deferred; see COMPLETED R2.18 entries.)*
