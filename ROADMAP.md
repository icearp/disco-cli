...
18. **Data services:** OpenSearch/ES, Neptune, DocumentDB — each separate scanner; prioritize by user demand. *(Glue catalog database+table + Athena workgroups+data-catalogs + Redshift cluster+subnet-group landed; Glue crawlers/jobs/triggers/classifiers/connections, Athena named-queries/prepared-statements, Redshift parameter-groups/snapshots/Serverless deferred; see COMPLETED R2.18 entries.)*
