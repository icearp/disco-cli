...
15. **Compute surfaces** — Elastic Beanstalk, Lightsail. *(App Runner + Batch landed. Lightsail = consumer-VPS, narrow audit value. Elastic Beanstalk = legacy, complex CFN-stack-orchestrating service. See COMPLETED R2.15 entries.)*
