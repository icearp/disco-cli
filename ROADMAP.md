...
18. **Data services:** Athena, Redshift, OpenSearch/ES, Neptune, DocumentDB — each separate scanner; prioritize by user demand. *(Glue catalog database+table landed; crawlers/jobs/triggers/classifiers/connections deferred within Glue itself; see COMPLETED R2.18.)*
