...
15. *(partial — Application Gateway scanner + AGW→VNet + AGW→PIP resolvers landed; Front Door + Traffic Manager + API Management deferred to follow-up iters; AGW→KeyVault deferred due to sanitizer false-positive on keyVaultSecretId — see COMPLETED R3.15)*
