...
15. **Compute surfaces** — Elastic Beanstalk, Lightsail, Batch. Group; each adds workload types + VPC/SG/IAM edges. *(App Runner services + VPC connectors landed; auto-scaling/observability/custom-domains/outbound-connections deferred within App Runner; see COMPLETED R2.15.)*
