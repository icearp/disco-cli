...
var expectedAzureServices = []string{
	...
	"azure:devhub",
	"azure:devtestlab",
	"azure:domainregistration",
	"azure:durabletask",
	"azure:fabric",
	"azure:fluidrelay",
	"azure:graphservices",
	"azure:hardwaresecuritymodules",
	"azure:integrationspaces",
	"azure:labservices",
	"azure:maintenance",
	"azure:migrationassessment",
	"azure:notificationhubs",
	"azure:powerplatform",
	"azure:redhatopenshift",
	"azure:springappdiscovery",
	"azure:aks",
	...
	"azure:avs",
	"azure:azurefleet",
	"azure:azurelargeinstance",
	"azure:azurearcdata",
	"azure:azurestackhci",
	"azure:baremetalinfrastructure",
	"azure:batch",
	"azure:botservice",
	"azure:cdn",
	"azure:chaos",
	...
	"azure:datareplication",
	"azure:mariadb",
	"azure:operationsmanagement",
	"azure:redisenterprise",
	"azure:dashboard",
	...
	"azure:horizondb",
	"azure:hybridcompute",
	"azure:hybridconnectivity",
	"azure:hybridcontainerservice",
	"azure:hybridnetwork",
	"azure:iothub",
	"azure:iotcentral",
	"azure:iotfirmwaredefense",
	"azure:iotoperations",
	"azure:keyvault",
	"azure:kubernetes",
	"azure:kusto",
