...
func init() {
	registerService(serviceEntry{
		...
		emits: []coverage.TypeDecl{
			...
			// is a future enrichment — ships scanner-only for now.
...
func scanStorageDiscovery(ctx context.Context, sub *subscription, cred *azidentity.DefaultAzureCredential, st *store.Store, scanID string) (total, inserted int, err error) {
