...
func init() {
	registerService(serviceEntry{
		...
		emits: []coverage.TypeDecl{
			...
			{Service: "mediaconnect", DiscoType: TypeMediaConnectFlow},
			...
			{Service: "mediaconnect", DiscoType: TypeMediaConnectGateway},
			{Service: "mediaconnect", DiscoType: TypeMediaConnectRouterInput},
			{Service: "mediaconnect", DiscoType: TypeMediaConnectRouterNetworkInterface},
			{Service: "mediaconnect", DiscoType: TypeMediaConnectRouterOutput},
		},
	})
}
