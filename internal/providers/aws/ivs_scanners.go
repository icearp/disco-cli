...
func init() {
	registerService(serviceEntry{
		...
		emits: []coverage.TypeDecl{
			...
			{Service: "ivs", DiscoType: TypeIVSEncoderConfiguration},
			{Service: "ivs", DiscoType: TypeIVSIngestConfiguration},
			{Service: "ivs", DiscoType: TypeIVSPlaybackKeyPair},
			{Service: "ivs", DiscoType: TypeIVSPlaybackRestrictionPolicy},
			{Service: "ivs", DiscoType: TypeIVSPublicKey},
