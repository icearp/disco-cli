...
type ec2API interface {
	...
	DescribeSecondaryInterfaces(context.Context, *ec2.DescribeSecondaryInterfacesInput, ...func(*ec2.Options)) (*ec2.DescribeSecondaryInterfacesOutput, error)
	DescribeSecondaryNetworks(context.Context, *ec2.DescribeSecondaryNetworksInput, ...func(*ec2.Options)) (*ec2.DescribeSecondaryNetworksOutput, error)
	DescribeSecondarySubnets(context.Context, *ec2.DescribeSecondarySubnetsInput, ...func(*ec2.Options)) (*ec2.DescribeSecondarySubnetsOutput, error)
