...
func scanEC2LocalGateway(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
	g, ctx := errgroup.WithContext(ctx)
	g.Go(func() error { return scanLocalGatewayRouteTables(ctx, client, acct, region, st, scanID) })
	g.Go(func() error { return scanLocalGatewayRoutes(ctx, client, acct, region, st, scanID) })
	g.Go(func() error { return scanLocalGatewayVirtualInterfaces(ctx, client, acct, region, st, scanID) })
	g.Go(func() error { return scanLocalGatewayVirtualInterfaceGroups(ctx, client, acct, region, st, scanID) })
	g.Go(func() error { return scanLocalGatewayRouteTableVPCAssociations(ctx, client, acct, region, st, scanID) })
	g.Go(func() error { return scanLocalGatewayRouteTableVIGAssociations(ctx, client, acct, region, st, scanID) })
	return g.Wait()
}

func scanLocalGatewayRouteTables(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
...
func scanLocalGatewayRoutes(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
	...
	for _, rtID := range rtIDs {
		rtID := rtID
		g.Go(func() error {
			return ec2PageScan(ctx, "ec2:SearchLocalGatewayRoutes", acct, region, st,
...
func scanLocalGatewayVirtualInterfaces(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
...
func scanLocalGatewayVirtualInterfaceGroups(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
...
func scanLocalGatewayRouteTableVPCAssociations(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
...
func scanLocalGatewayRouteTableVIGAssociations(ctx context.Context, client *ec2.Client, acct *account, region string, st *store.Store, scanID string) error {
