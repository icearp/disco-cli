...
func init() {
	registerType(restype.Descriptor{Type: TypeLexBot, Service: "lex"})
	...
	registerType(restype.Descriptor{Type: TypeLexTestSet, Service: "lex", Upstream: "AWS::lex::test set", Leaf: true})
