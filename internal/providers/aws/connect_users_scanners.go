...
func init() {
	registerExtraEmits(
		coverage.TypeDecl{Service: "connect", DiscoType: TypeConnectUser},
		coverage.TypeDecl{Service: "connect", DiscoType: TypeConnectUserHierarchyGroup},
		coverage.TypeDecl{Service: "connect", DiscoType: TypeConnectUserHierarchyStructure},
		coverage.TypeDecl{Service: "connect", DiscoType: TypeConnectSecurityProfile},
		coverage.TypeDecl{Service: "connect", DiscoType: TypeConnectPredefinedAttribute},
	)
}
