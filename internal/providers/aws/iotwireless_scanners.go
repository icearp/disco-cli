...
func init() {
	registerService(serviceEntry{
		...
		emits: []coverage.TypeDecl{
			...
			{Service: "iotwireless", DiscoType: TypeIoTWirelessDeviceProfile},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessFuotaTask},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessMulticastGroup},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessNetworkAnalyzerConfiguration},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessPartnerAccount},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessServiceProfile},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessTaskDefinition},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessWirelessDevice},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessWirelessDeviceImportTask},
			{Service: "iotwireless", DiscoType: TypeIoTWirelessWirelessGateway},
		},
	})
}
