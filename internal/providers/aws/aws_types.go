...
const (
	...
	TypeWAFRuleGroup            = "aws:waf:rule-group"
	TypeWAFRateBasedRule        = "aws:waf:rate-based-rule"
	TypeWAFIPSet                = "aws:waf:ip-set"
	TypeWAFByteMatchSet         = "aws:waf:byte-match-set"
	TypeWAFGeoMatchSet          = "aws:waf:geo-match-set"
	TypeWAFRegexMatchSet        = "aws:waf:regex-match-set"
	TypeWAFRegexPatternSet      = "aws:waf:regex-pattern-set"
	TypeWAFSizeConstraintSet    = "aws:waf:size-constraint-set"
	TypeWAFSQLInjectionMatchSet = "aws:waf:sql-injection-match-set"
	TypeWAFXSSMatchSet          = "aws:waf:xss-match-set"
	// WAF Classic v1 — regional scope (wafregional_scanners.go, wafregional_resolvers.go)
	TypeWAFRegionalWebACL               = "aws:wafregional:web-acl"
	TypeWAFRegionalRule                 = "aws:wafregional:rule"
	TypeWAFRegionalRuleGroup            = "aws:wafregional:rule-group"
	TypeWAFRegionalRateBasedRule        = "aws:wafregional:rate-based-rule"
	TypeWAFRegionalIPSet                = "aws:wafregional:ip-set"
	TypeWAFRegionalByteMatchSet         = "aws:wafregional:byte-match-set"
	TypeWAFRegionalGeoMatchSet          = "aws:wafregional:geo-match-set"
	TypeWAFRegionalRegexMatchSet        = "aws:wafregional:regex-match-set"
	TypeWAFRegionalRegexPatternSet      = "aws:wafregional:regex-pattern-set"
	TypeWAFRegionalSizeConstraintSet    = "aws:wafregional:size-constraint-set"
	TypeWAFRegionalSQLInjectionMatchSet = "aws:wafregional:sql-injection-match-set"
	TypeWAFRegionalXSSMatchSet          = "aws:wafregional:xss-match-set"
	TypeWAFRegionalWebACLAssociation    = "aws:wafregional:web-acl-association"
	...
	// Service Quotas has no resource type: a quota is a limit value, scanned by
	// aws:servicequotas into the `quotas` table rather than into `resources`.
	// SNS
	...
	TypeQuickSightAccount                = "aws:quicksight:account"
	TypeQuickSightActionConnector        = "aws:quicksight:action-connector"
	TypeQuickSightAgent                  = "aws:quicksight:agent"
	TypeQuickSightAnalysis               = "aws:quicksight:analysis"
	TypeQuickSightAssignment             = "aws:quicksight:assignment"
	TypeQuickSightBrand                  = "aws:quicksight:brand"
	TypeQuickSightCustomization          = "aws:quicksight:customization"
	...
	TypeQuickSightFlow                   = "aws:quicksight:flow"
	TypeQuickSightFolder                 = "aws:quicksight:folder"
	TypeQuickSightGroup                  = "aws:quicksight:group"
	TypeQuickSightKnowledgeBase          = "aws:quicksight:knowledge-base"
	TypeQuickSightNamespace              = "aws:quicksight:namespace"
	TypeQuickSightOAuthClientApplication = "aws:quicksight:oauth-client-application"
	TypeQuickSightRefreshSchedule        = "aws:quicksight:refresh-schedule"
	TypeQuickSightSpace                  = "aws:quicksight:space"
	...
	TypeQuickSightUser                   = "aws:quicksight:user"
	...
	TypeQBusinessSubscription              = "aws:qbusiness:subscription"
	TypeQBusinessWebExperience             = "aws:qbusiness:web-experience"
	// QApps (qapps_scanners.go)
	TypeQAppsQApp = "aws:qapps:qapp"
	...
	TypeCleanRoomsConfiguredAudienceModelAssociation = "aws:cleanrooms:configured-audience-model-association"
	...
	TypeSMSVoiceRegistrationAttachment    = "aws:sms-voice:registration-attachment"
	TypeSMSVoiceVerifiedDestinationNumber = "aws:sms-voice:verified-destination-number"
	...
	// IoTManagedIntegrations (iotmanagedintegrations_scanners.go)
	...
	TypeFraudDetectorModel         = "aws:frauddetector:model"
	...
	TypeBedrockAgentCoreConfigurationBundle       = "aws:bedrockagentcore:configuration-bundle"
	TypeBedrockAgentCoreDataset                   = "aws:bedrockagentcore:dataset"
	TypeBedrockAgentCoreEvaluator                 = "aws:bedrockagentcore:evaluator"
	TypeBedrockAgentCoreHarness                   = "aws:bedrockagentcore:harness"
	TypeBedrockAgentCoreHarnessEndpoint           = "aws:bedrockagentcore:harness-endpoint"
	TypeBedrockAgentCorePolicyGeneration          = "aws:bedrockagentcore:policy-generation"
	TypeBedrockAgentCoreRegistry                  = "aws:bedrockagentcore:registry"
	TypeBedrockAgentCoreRegistryRecord            = "aws:bedrockagentcore:registry-record"
	...
	TypeBedrockAgentCorePaymentManager            = "aws:bedrockagentcore:payment-manager"
	TypeBedrockAgentCorePaymentConnector          = "aws:bedrockagentcore:payment-connector"
	TypeBedrockAgentCorePaymentCredentialProvider = "aws:bedrockagentcore:payment-credential-provider"
