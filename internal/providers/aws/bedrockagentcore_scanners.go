...
func init() {
	registerService(serviceEntry{
		...
		emits: []coverage.TypeDecl{
			...
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreEvaluator},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreGateway},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreGatewayTarget},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreMemory},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreOAuth2CredentialProvider},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreOnlineEvaluationConfig},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCorePolicy},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCorePolicyEngine},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreRuntime},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreRuntimeEndpoint},
			{Service: "bedrockagentcore", DiscoType: TypeBedrockAgentCoreWorkloadIdentity},
		},
	})
}
