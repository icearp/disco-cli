...
func init() {
	registerExtraEmits(
		coverage.TypeDecl{Service: "iot", DiscoType: TypeIoTLogging},
		coverage.TypeDecl{Service: "iot", DiscoType: TypeIoTResourceSpecificLogging},
		coverage.TypeDecl{Service: "iot", DiscoType: TypeIoTEncryptionConfiguration},
	)
}
