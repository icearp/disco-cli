...
func init() {
	registerExtraEmits(
		...
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeHealthCheck},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeRegionHealthCheck},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeRegionCompositeHealthCheck},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeRegionHealthAggregationPolicy},
		...
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeRegionNotificationEndpoint},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeHttpHealthCheck},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeHttpsHealthCheck},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeSslCertificate},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeRegionSslCertificate},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeSslPolicy},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeRegionSslPolicy},
