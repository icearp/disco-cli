...
func init() {
	registerOrgService(orgServiceEntry{
		...
		emits: []coverage.TypeDecl{
			...
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityDevice},
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityDeviceUser},
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityClientState},
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityMembership},
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityInboundOidcSsoProfile},
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityInboundSamlSsoProfile},
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityIdpCredential},
			...
			{Service: "cloudidentity", DiscoType: TypeCloudIdentityUserinvitation},
		},
	})
}
