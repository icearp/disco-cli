...
func init() {
	registerExtraEmits(
		...
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeExternalVpnGateway},
		...
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeNetworkProfile},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeNodeGroup},
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeNodeTemplate},
		...
		coverage.TypeDecl{Service: "compute", DiscoType: TypeComputeCrossSiteNetwork},
